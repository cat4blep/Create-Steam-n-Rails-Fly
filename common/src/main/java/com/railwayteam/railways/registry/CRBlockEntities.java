...
public class CRBlockEntities {
    ...
    public static final BlockEntityEntry<SmokeStackBlockEntity> SMOKE_STACK = REGISTRATE.blockEntity("smokestack", SmokeStackBlockEntity::new)
        .validBlocks(CRBlocks.CABOOSESTYLE_STACK, CRBlocks.LONG_STACKS.getFirst(), CRBlocks.COALBURNER_STACKS.getFirst(), CRBlocks.OILBURNER_STACKS.getFirst(), CRBlocks.STREAMLINED_STACKS.getFirst(), CRBlocks.WOODBURNER_STACKS.getFirst())
        .register();
