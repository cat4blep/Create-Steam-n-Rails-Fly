...
public class BlockBuilder<T extends Block, P> extends AbstractBuilder<T, P, BlockBuilder<T, P>> {
    ...
    public BlockBuilder<T, P> loot(NonNullBiConsumer<? super com.railwayteam.railways.internal.compat.registrate.providers.loot.RegistrateBlockLootTables, ? super T> consumer) {
        return this;
    }
